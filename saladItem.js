...
// Items for a list of Salad options for the Salad Maker Interface
...
// Provides a viewable list of Salad Items by Image and Name
export default function SaladItem({ image, name }) {
  ...
  return(
    <div className={classes.wrapper}>
        ...
        <button className={classes.add} onClick={update} onTouchMove={}>
